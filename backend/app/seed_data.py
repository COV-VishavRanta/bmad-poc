...
from app.models import (
    ...
    Client, ClientContact, ClientStatus, RelationType,
    SOW, SOWStatus, SOWRole, SOWRoleName,
    Group, Project, ProjectType, ProjectStatus,
...
def create_demo_sows(db: Session, clients: dict, users: dict) -> dict:
    ...
    sow_roles_techcorp = [
        SOWRole(sow=techcorp_sow, role_name=SOWRoleName.BACKEND_DEVELOPER, fte_allocation=Decimal('1.0'), hourly_rate=Decimal('85.00')),
        SOWRole(sow=techcorp_sow, role_name=SOWRoleName.FRONTEND_DEVELOPER, fte_allocation=Decimal('1.0'), hourly_rate=Decimal('80.00')),
        SOWRole(sow=techcorp_sow, role_name=SOWRoleName.ARCHITECT, fte_allocation=Decimal('0.5'), hourly_rate=Decimal('120.00')),
        SOWRole(sow=techcorp_sow, role_name=SOWRoleName.PROJECT_MANAGER, fte_allocation=Decimal('0.5'), hourly_rate=Decimal('90.00')),
        SOWRole(sow=techcorp_sow, role_name=SOWRoleName.TESTER, fte_allocation=Decimal('0.5'), hourly_rate=Decimal('65.00'))
    ]
    ...
    sow_roles_startup = [
        SOWRole(sow=startup_sow, role_name=SOWRoleName.BACKEND_DEVELOPER, fte_allocation=Decimal('0.75'), hourly_rate=Decimal('80.00')),
        SOWRole(sow=startup_sow, role_name=SOWRoleName.FRONTEND_DEVELOPER, fte_allocation=Decimal('0.75'), hourly_rate=Decimal('75.00')),
        SOWRole(sow=startup_sow, role_name=SOWRoleName.DESIGNER, fte_allocation=Decimal('0.5'), hourly_rate=Decimal('70.00'))
    ]
