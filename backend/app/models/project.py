...
from sqlalchemy import Column, Integer, String, Enum, Text, Date, DateTime, JSON, ForeignKey, Index, CheckConstraint
...
class Project(BaseModel):
    ...
    def get_total_fte(self) -> float:
        ...
        total = sum(assignment.fte_allocation for assignment in self.assignments 
